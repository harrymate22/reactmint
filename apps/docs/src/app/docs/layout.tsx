          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="hidden sm:flex items-center relative w-48 lg:w-64">
              ...
              <input 
                type="text" 
                placeholder="Search..." 
                className="w-full pl-9 pr-12 h-9 bg-foreground/5 border border-foreground/10 hover:border-foreground/20 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-colors rounded-full text-xs text-foreground placeholder:text-muted-foreground"
              />
